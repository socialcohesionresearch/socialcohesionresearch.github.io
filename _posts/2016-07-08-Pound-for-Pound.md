...
<p style="text-align: center;" ><img src="{{site.url}}/images/blog-images/conversation_1.PNG"></p>
<div class='spacing'></div>
...
<p style="text-align: center;" ><img src="{{site.url}}/images/blog-images/pound_conversation.PNG"></p>
<div class='spacing'></div>
...
While this has since corrected, the Pound dropped as much as 9%, and the value of Bitcoin climbed by 8% immediately following the vote.
</p>
<p style="text-align: center;" ><img src="{{site.url}}/images/blog-images/crypto_conversation.PNG"></p>
<div class='spacing'></div>
...
<p style="text-align: center;" ><img src="{{site.url}}/images/blog-images/pound_wheel.PNG"></p>
<p>While the Crypto Currency conversation was more hopeful:</p>
<p style="text-align: center;" ><img src="{{site.url}}/images/blog-images/crypto_wheel.PNG"></p>
<div class='spacing'></div>
<h3>Affinities</h3>
